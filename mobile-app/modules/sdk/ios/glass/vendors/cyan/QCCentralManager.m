...
- (void)remove {
    ...
    // Must set state BEFORE cancelPeripheralConnection — the didDisconnect
    // callback can fire synchronously and checks this to decide whether to
    // auto-reconnect.
...
- (void)centralManagerDidUpdateState:(CBCentralManager *)central {
    ...
    if (bleState == QCBluetoothStatePoweredOn && self.deviceState == QCStateConnecting && self.autoReconnect) {
